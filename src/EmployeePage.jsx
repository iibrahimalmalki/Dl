...
export default function EmployeePage({onBack,employeeId}){
  ...
  return(<div style={g.page}>
    <div style={{background:"linear-gradient(135deg,#25D366,#128C7E)",margin:"12px 16px 0",borderRadius:14,padding:"12px 14px",display:"flex",alignItems:"center",justifyContent:"space-between",gap:10}}>
      ...
      <a href={`https://wa.me/?text=${refMsg}`} target="_blank" rel="noreferrer" style={{flexShrink:0,padding:"9px 14px",background:"#fff",borderRadius:10,color:"#128C7E",fontSize:12,fontWeight:800,textDecoration:"none"}}>📤 শেয়ার</a>
    </div>
